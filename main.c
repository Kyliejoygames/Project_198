...
int main(void)
{
  ...
  while (1)
  {
	  // Hold the trigger pin high for at least 10 us
	     ...
	     t2 = HAL_GetTick();
	     pulse_width = (t2 - t1) * 1000; // convert to microseconds

	     // Calculate distance in centimeters and inches
	     double cm = pulse_width / 58.0;
	    ...
	    sprintf((char*)buffer, "value: %u.%u \r\n", (unsigned int)cm, DEC(cm));


	  //sprintf((char*)buffer, "value: %u \r\n", (unsigned int)adcValue);
